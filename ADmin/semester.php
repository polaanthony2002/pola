...
$ret=mysqli_query($con,"insert into semester(title, description) values('$title', '$description')");
if($ret)
{
$_SESSION['msg']="Meeting Created Successfully !!";
}
else
{
  $_SESSION['msg']="Error : Meeting not created";
}
}
if(isset($_GET['del']))
      {
              mysqli_query($con,"delete from  semester where id = '".$_GET['id']."'");
                  $_SESSION['delmsg']="Meeting deleted !!";
      }
?>
 ...
 ?>
    ...
    <div class="content-wrapper">
        <div class="container">
              <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">POLLS//Meetings  </h1>
                    </div>
                </div>
                <div class="row" >
...
<font color="green" align="center"><?php echo htmlentities($_SESSION['msg']);?><?php echo htmlentities($_SESSION['msg']="");?></font>
   ...
   <div class="form-group">
    ...
    <input type="text" class="form-control" id="title" name="title" placeholder="Meeting " required />
  </div>
